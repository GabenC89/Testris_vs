...
bool GameEngine::createGameWindow()
{
	...
	{
		gameWindow = SDL_CreateWindow(windowTitle, windowWidth, windowHeight, SDL_WINDOW_FULLSCREEN);
	}
	else 
	{
		gameWindow = SDL_CreateWindow(windowTitle, windowWidth, windowHeight, SDL_WINDOW_RESIZABLE);
	}
...
bool GameEngine::init()
{
	...
	//Initialize SDL3
	if (SDL_InitSubSystem(SDL_INIT_VIDEO) == false || SDL_InitSubSystem(SDL_INIT_EVENTS) == false)
	{
